  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(20, 15%, 8%) 0%, hsl(25, 20%, 12%) 30%, hsl(30, 25%, 10%) 70%, hsl(20, 15%, 6%) 100%)",
        }}
      >
        {/* Golden Light Rays */}
        <CheckoutBackgroundEffects />

        {/* Golden border glow */}
        <div
          className="absolute inset-0 rounded-3xl border-2 border-secondary/60"
          style={{
            boxShadow:
              "inset 0 0 60px hsl(43, 74%, 49%, 0.2), 0 0 40px hsl(43, 74%, 49%, 0.15)",
          }}
        />
        ...
        <div className="relative z-10 p-5 md:p-8 text-center space-y-4">
          {/* Logo */}
          <CheckoutLogo />
          ...
          >
            <h2 className="font-display font-bold tracking-wider text-center">
              <span
                className="block text-xs sm:text-sm md:text-lg lg:text-xl mb-1"
                style={{
                  background:
                    "linear-gradient(180deg, hsl(45, 100%, 85%) 0%, hsl(43, 74%, 49%) 50%, hsl(35, 70%, 40%) 100%)",
              ...
              <span
                className="block text-xl sm:text-2xl md:text-4xl lg:text-5xl"
                style={{
                  background:
                    "linear-gradient(180deg, hsl(45, 100%, 90%) 0%, hsl(43, 74%, 49%) 40%, hsl(35, 70%, 40%) 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
          ...
          <motion.p
            ...
            className="text-xs sm:text-sm md:text-base max-w-sm mx-auto"
            style={{ color: "hsl(43, 30%, 75%)" }}
          >
            Your design is unique and spectacular. Don't let someone else take
            your date.
          </motion.p>
          ...
          >
            ...
            <motion.span
              ...
              className="font-display text-3xl sm:text-4xl md:text-5xl font-bold block"
              style={{
                background:
                  "linear-gradient(180deg, hsl(45, 100%, 90%) 0%, hsl(43, 74%, 49%) 40%, hsl(38, 70%, 45%) 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                filter: "drop-shadow(0 4px 8px rgba(0,0,0,0.4))",
              }}
          ...
          >
            ...
            <div className="space-y-1">
              <motion.div
                animate={{
                  scale: [1, 1.02, 1],
                  boxShadow: [
                    "0 0 20px hsl(43, 74%, 49%, 0.4), 0 8px 30px rgba(0,0,0,0.3)",
                    "0 0 40px hsl(43, 74%, 49%, 0.7), 0 12px 40px rgba(0,0,0,0.4)",
                    "0 0 20px hsl(43, 74%, 49%, 0.4), 0 8px 30px rgba(0,0,0,0.3)",
                  ],
                }}
                transition={{
              ...
              >
                <Button
                  onClick={() => openForm("taster")}
                  className="w-full py-5 sm:py-6 font-bold tracking-wide rounded-xl transition-all duration-300 hover:scale-[1.02]"
                  style={{
                    background:
                      "linear-gradient(135deg, hsl(43, 74%, 49%) 0%, hsl(38, 80%, 45%) 50%, hsl(43, 74%, 49%) 100%)",
                    color: "hsl(20, 15%, 8%)",
            ...
            <div className="flex items-center gap-3 px-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, transparent, hsl(43, 40%, 40%), transparent)",
                }}
              />
              <span
                className="text-[10px] sm:text-xs uppercase tracking-widest font-medium"
                style={{ color: "hsl(43, 30%, 50%)" }}
              >
                or
              </span>
              <div
          ...
          <motion.button
            ...
            onClick={onGoBack}
            className="text-[10px] sm:text-xs transition-colors underline underline-offset-4 mt-2"
            style={{ color: "hsl(43, 20%, 50%)" }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.color = "hsl(43, 30%, 70%)")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = "hsl(43, 20%, 50%)")
            }
          >
...
function CheckoutBackgroundEffects() {
  return (
    <>
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 180deg at 50% 0%, transparent 40%, hsl(43, 74%, 49%) 48%, hsl(45, 80%, 70%) 50%, hsl(43, 74%, 49%) 52%, transparent 60%)",
            opacity: 0.15,
          }}
        />
      </div>
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top, hsl(43, 74%, 49%, 0.25) 0%, hsl(43, 74%, 49%, 0.1) 30%, transparent 70%)",
        }}
      />
    </>
  );
      ...
      <div className="relative">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(43, 74%, 49%, 0.5) 0%, hsl(43, 74%, 49%, 0.2) 50%, transparent 70%)",
            }}
          />
        </motion.div>
        <motion.img
          ...
          className="w-28 sm:w-36 h-auto md:w-48 relative z-10"
          animate={{
            filter: [
